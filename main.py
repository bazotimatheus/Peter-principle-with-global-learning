...
for output in range(MAX_EXECUTIONS):
  ...
  nomes_colunas = ['level', 'age', 'competence', 'normalized_competence', 'efficiency'] + ['skill_'+str(x) for x in range(COMPETENCES)]
  ...
  # for iteration in range(MAX_ITERATIONS):
    ...
    dataset = update_skill_vector(dataset, qualifications, LEARNING)
